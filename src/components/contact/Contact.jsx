            ...
            <div className="container contact__container">
                <div className="contact__options">
                    ...
                    <article className="contact__option">
                        ...
                        <h4>Messenger</h4>
                        <h5>Code_NNature</h5>
                        <a href="https://m.me/ivan.buitrago.988/" target="_blank"> Send a Message </a>
                    </article>
                    ...
                    <article className="contact__option">
                        ...
                        <h4>WhatsApp</h4>
                        <h5>329674652</h5>
                        <a href="https://api.whatsapp.com/send?phone=+573204833432" target="_blank"> Send a Message </a>
                    </article>
                </div>
